...
if __name__ == '__main__':
    img_dir = 'data-pre/imgs/test'	# 图片文件路径
    msk_dir = 'data-pre/masks/test'	# 标签文件路径
    #img_type = '.png'
    img_tmp_dir = 'data-after/imgs/test'	# 输出图片文件路径
    msk_tmp_dir = 'data-after/masks/test'
